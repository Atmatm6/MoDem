...
@Plugin(name = "MoDemConfigurationFactory", category = ConfigurationFactory.CATEGORY)
@Order(50)
public class MoDemConfigurationFactory extends ConfigurationFactory {
    ...
    static Configuration createConfiguration(final String name, ConfigurationBuilder<BuiltConfiguration> builder) {
        ...
        builder.add(builder.newLogger("MoDem", Level.INFO).add(builder.newAppenderRef("Stdout")).addAttribute("additivity", false));
